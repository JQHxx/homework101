...
-(void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
    ...
    if ([url rangeOfString:@"getcoupon"].location != NSNotFound||[url rangeOfString:@"applyguide"].location != NSNotFound||[url rangeOfString:@"contectteacher"].location != NSNotFound||[url rangeOfString:@"getdiscounts"].location != NSNotFound||[url rangeOfString:@"lookfirst"].location != NSNotFound) {
